...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  ...
  <!--FINAL DEL CARRUSEL-->
    ...
    <div class="container-fluid text-white text-center">
        <!--BOTON DEL MODAL-->
        <button type="button" id="model-register" class="neonbottonlanding btn btn-primary my-0 my-sm-3 border-0" data-bs-toggle="modal" data-bs-target="#modalAsesoria" onclick="AsesoriaNeg()">
        ...
        <!--Inicio Modal-->
            ...
            <div class="modal-dialog">
                ...
                <main class="main rounded-25 row pb-5 d-flex justify-content-center">
                    ...
                    <div class="mainContent neontabla col-8 my-5 pb-3">
                        <h3 class="my-3 fs-2 neones p-50">¿Quieres tener un Negocio visualmente atractivo?</h3>
            ...
            <div class="row questionNosotros py-2 py-sm-1 d-flex justify-content-center">
                ...
                <p class="paragraph mt-3 w-75  px-4 px-sm-5 border border-5 rounded-3">"Entendemos la importancia de la decoración en tu negocio para 
                    ofrecer el ambiente que tu cliente merece, con nosotros para lograrlo"</p>      
            </div>
                        ...
                        <div class="modal-content" id="modCatalogo">
                            ...
                            <form class="formContact1 landingPageForm col-sm-12" id="formContact1" method="POST">
                                <div class="modal-body mx-5">
                                    ...
                                    <div class="modal-field">
                                        <input type="hidden" class="form-control my-3" name="pregunta" id="mod_pregunta" value="Interesado en luces Negocios">
                                    </div>
                                    
                                    <button type="submit" class="neonbottonlanding btn btn-primary" onclick="verCatalogoN();">Enviar y Mostrar</button>
                                </div>
                            </form>
...
<!--LandingPageNegocio-->
            <div class="landin1 arreglo" id="Catalogo">
                ...
                <h1 class="title">¡LOS MEJORES DISEÑOS PARA NEGOCIOS!</h1>
